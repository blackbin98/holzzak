...
Firebase Firestore를 이용한 2인용 홀짝 게임입니다. 한 명은 0부터 5까지 숫자를 고르고, 다른 한 명은 홀/짝을 맞힙니다. 선택 시간은 30초이며, 승부가 나면 승자 이름과 축하 메시지가 화면에 표시됩니다.
...
4. 개발 중 테스트용 Firestore Rules 예시는 아래와 같습니다.

```js
rules_version = '2';
service cloud.firestore {
  match /databases/{database}/documents {
    match /oddEvenRooms/{roomId} {
...
공개 배포 전에는 인증 또는 방 코드 기반 검증을 추가해 Rules를 강화하세요.
