...
Firebase Realtime Database를 이용한 2인용 홀짝 게임입니다. 한 명은 0부터 5까지 숫자를 고르고, 다른 한 명은 홀/짝을 맞힙니다. 선택 시간은 30초이며, 승부가 나면 승자 이름과 축하 메시지가 화면에 표시됩니다.
...
공개 배포 전에는 인증 또는 방 코드 기반 검증을 추가해 Rules를 강화하세요. 지금 규칙은 로그인 없는 2인 방 코드 게임이 작동하도록 `oddEvenRooms`만 열어둔 설정입니다.
